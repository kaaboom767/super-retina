%% This is the meta script for tRNS Pilot 1. It runs the other scripts and of the experiment. Pros for this meta script are the
...
p.SessionNr = 1;
run final_threshold_visual_with_quest.m

%% T-Test script for data of pilot 4, median version
...
%     AnalysisData = convertCharsToStrings(AnalysisData);
    ...
    matDataDir = [WorkingDirData '*_bootstrapped_analysis_median.mat'];
    ...
    accuracyArray   = [accuracyArray, matData.finalMedian];
